...
echo "<h3 style='right:23%;position:absolute;top:0;'><a href='entries.php' style='background:#4CAF50;color:#fff;border-radius:6px;border-bottom-left-radius:0;border-bottom-right-radius:0;padding:8px;text-decoration:none;'>Entries</a></h3>";
